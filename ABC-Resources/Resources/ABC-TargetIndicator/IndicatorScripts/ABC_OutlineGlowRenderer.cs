...
namespace ABCToolkit {
    [ExecuteInEditMode]
    public class ABC_OutlineGlowRenderer : MonoBehaviour {
        [ColorUsageAttribute(true, true)] public Color outlineColor = Color.white;
        [Range(0.0f, 1000.0f)] public float outlinePixelWidth = 1f;
        ...
        const string shaderName = "ABC/ABC_OutlineGlow";
        ...
        private void CreateCommandBuffer(Camera cam) {
            ...
            if (cb == null) {
                ...
                cb.name = "ABC_OutlineGlowRenderer: " + gameObject.name;
            } else {
                cb.Clear();
            }
            ...
            for (int i = 0; i < renderersCount; i++) {
                ...
                //Debug.Assert(mesh != null, "ABC_OutlineGlowRenderer's renderer [" + i + "] is missing a valid mesh.", gameObject);
                if (mesh != null) {
